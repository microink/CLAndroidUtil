...
jlong Java_com_clandroid_plog_record_impl_MmapLogWriter_nativeInit(JNIEnv *env,
                                                              jobject object,
                                                              jstring basic_info,
                                                              jstring dir) {
...
jlong Java_com_clandroid_plog_record_impl_MmapLogWriter_nativeWrite(JNIEnv *env,
                                                               jobject object,
...
void Java_com_clandroid_plog_record_impl_MmapLogWriter_nativeRefreshBasicInfo(JNIEnv *env,
                                                                         jobject object,
                                                                         jlong log_writer_object,
                                                                         jstring basic_info) {
    //////////////////////////////////////
 ...
 */
void Java_com_clandroid_plog_record_impl_MmapLogWriter_nativeCloseAndRenew(JNIEnv *env, jobject object,
...
Java_com_clandroid_plog_record_impl_MmapLogWriter_nativeGetFileSize(JNIEnv *env, jobject instance,
                                                               jlong log_writer_object) {
